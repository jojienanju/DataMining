...
WORDS = ['#DigiFun', '#FreedomToInternet', '#MalaysiaLargestNetwork', '#5GMalaysia', '#ProgressingHumanity', '#JomInternet', '#DigiUpdate', '#DIGI', '#investors', '#shareholders', 'Builderall', '#digimalaysia', '#DigitalTransformation', '#Digi5G', '#starbiz', '#Asia', '#News', '#stockname', '#stockcode', '#price', '#OpenPrice'
...
def store_data(created_at, text, screen_name, tweet_id):
    ...
    cursor = db.cursor()
    insert_query = "INSERT INTO TwitterDigi (tweet_id, screen_name, created_at, text) VALUES (%s, %s, %s, %s)"
