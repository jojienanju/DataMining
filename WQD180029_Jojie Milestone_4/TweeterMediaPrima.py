...
WORDS = ['#MediaPrima', '#MediaPrimaBerhad', '#newstraitstimes', '#nstinsight', '#Asia', '#News', '#stockname', '#stockcode', '#price', '#OpenPrice'
...
def store_data(created_at, text, screen_name, tweet_id):
    ...
    cursor = db.cursor()
    insert_query = "INSERT INTO TwitterMediaPrima (tweet_id, screen_name, created_at, text) VALUES (%s, %s, %s, %s)"
